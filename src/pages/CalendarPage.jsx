...
const CalendarPage = () => {
  ...
  const handleDeleteTask = async (taskId) => {
    ...
    setTaskToDelete({ id: taskId, title: selectedTask.title });
          ...
          <div className="relative z-10 w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="w-full md:w-auto">
              ...
              <p className="text-slate-400 mt-1 text-sm sm:text-lg font-light">
                ...
                <span className="text-slate-500 ml-1 block sm:inline">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
              {user.role === 'super-admin' && (
                <Button
                  ...
                  className="bg-white/5 border-white/10 text-slate-300 hover:bg-white/10 hover:text-white transition-all rounded-xl h-10 px-4 font-medium backdrop-blur-sm w-full sm:w-auto"
                >
              ...
              {(user.role === 'admin' || user.role === 'super-admin') && (
                <Button
                  ...
                  className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white shadow-lg shadow-purple-500/20 rounded-xl h-10 px-6 font-semibold transition-all w-full sm:w-auto"
                >
