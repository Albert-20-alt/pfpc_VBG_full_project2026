...
const EditTermsPage = () => {
    ...
    const handleSave = async () => {
        try {
            setSaving(true);
            await api.updateContent('terms_of_service', content);
            toast({
                title: "Succès",
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        <h1 className="text-3xl font-bold text-white flex items-center gap-3">
                            ...
                            Éditer les Conditions d'Utilisation
                        </h1>
                        <p className="text-slate-400 mt-1">
                            Modifiez le contenu visible sur la page publique des conditions d'utilisation.
                        </p>
                    </div>
                    <Button
                        onClick={handleSave}
